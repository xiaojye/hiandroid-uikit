 ...
 * @since 1.0
 */
public class HIUIRoundImageView extends AppCompatImageView implements HIUIRoundAction {

    private HIUIRoundHelper mRoundHelper = new HIUIRoundHelper();

    public HIUIRoundImageView(Context context) {
        this(context, null);
    }

    public HIUIRoundImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HIUIRoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
