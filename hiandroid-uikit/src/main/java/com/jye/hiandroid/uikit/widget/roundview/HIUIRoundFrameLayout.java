 ...
 * @since 1.0
 */
public class HIUIRoundFrameLayout extends FrameLayout implements HIUIRoundAction {

    private HIUIRoundHelper mRoundHelper = new HIUIRoundHelper();

    public HIUIRoundFrameLayout(Context context) {
        this(context, null);
    }

    public HIUIRoundFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HIUIRoundFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
