 ...
 * @since 1.0
 */
public class HIUIRadioGroupLayout extends LinearLayout {
    ...
    public HIUIRadioGroupLayout(Context context) {
        super(context);
        setOrientation(LinearLayout.VERTICAL);
        init();
    }

    public HIUIRadioGroupLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(HIUIRadioGroupLayout group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == HIUIRadioGroupLayout.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == HIUIRadioGroupLayout.this && child instanceof ViewGroup) {
