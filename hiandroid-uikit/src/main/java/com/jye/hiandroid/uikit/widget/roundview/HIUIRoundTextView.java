 ...
 * @since 1.0
 */
public class HIUIRoundTextView extends AppCompatTextView implements HIUIRoundAction {

    private HIUIRoundHelper mRoundHelper = new HIUIRoundHelper();

    public HIUIRoundTextView(Context context) {
        this(context, null);
    }

    public HIUIRoundTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HIUIRoundTextView(Context context, AttributeSet attrs, int defStyleAttr) {
