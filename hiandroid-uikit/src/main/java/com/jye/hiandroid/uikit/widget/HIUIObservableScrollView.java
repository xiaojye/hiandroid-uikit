 ...
 * @since 1.0
 */
public class HIUIObservableScrollView extends ScrollView {

    private int mScrollOffset = 0;

    private List<OnScrollChangedListener> mOnScrollChangedListeners;

    public HIUIObservableScrollView(Context context) {
        super(context);
    }

    public HIUIObservableScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HIUIObservableScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnScrollChangedListener {
        void onScrollChanged(HIUIObservableScrollView scrollView, int scrollX, int scrollY, int oldScrollX, int oldScrollY);
    }
