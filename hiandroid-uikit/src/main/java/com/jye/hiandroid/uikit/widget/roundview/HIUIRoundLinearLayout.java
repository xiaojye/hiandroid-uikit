 ...
 * @since 1.0
 */
public class HIUIRoundLinearLayout extends LinearLayout implements HIUIRoundAction {

    private HIUIRoundHelper mRoundHelper = new HIUIRoundHelper();

    public HIUIRoundLinearLayout(Context context) {
        this(context, null);
    }

    public HIUIRoundLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HIUIRoundLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
